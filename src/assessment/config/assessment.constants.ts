export const areaAssessmentItems = {
    ...
    "Calidad Académica": [
        ...
        "Presenta por lo menos 3 recursos didácticos por Unidad (videos, imagen, Tablas).",
        "La sustentación teórico de la materia está correctamente redactado y debidamente referenciada.",
        "Las preguntas guías de autoevaluación de las lecciones están formuladas correctamente.",
        "Se muestran con claridad los criterios de evaluación.",
        "El planteamiento del banco de preguntas están formuladas correctamente (preguntas y respuestas)."
    ],
};
